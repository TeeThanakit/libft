...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2022/09/27 17:05:43 by tchokbun          #+#    #+#              #
#    Updated: 2022/10/13 17:40:26 by tchokbun         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = ft_isalpha.c ft_isdigit.c ft_isalnum.c ft_isascii.c ft_strlen.c ft_isprint.c ft_toupper.c ft_tolower.c ft_strchr.c ft_strrchr.c ft_memset.c ft_bzero.c ft_memcpy.c ft_memmove.c
...
#bonus: $(OBJS) $(BONUS_OBJS) ar rcs $(NAME) $(OBJS) $(BONUS_OBJS)
